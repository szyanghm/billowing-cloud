package com.red.dust.billowing.handler;

import com.red.dust.billowing.common.ChatProto;
import com.red.dust.billowing.common.UserInfo;
import com.red.dust.billowing.util.NettyUtil;
...
public class UserInfoManager {
    ...
    public static boolean saveUser(Channel channel, UserInfoVO vo) {
        ...
        if (!channel.isActive()) {
            logger.error("channel is not active, address: {}, nick: {}", userInfo.getAddr(), vo.getNickName());
            return false;
        }
        // 增加一个认证用户
